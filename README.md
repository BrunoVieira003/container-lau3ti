...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lau3ti.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lau3ti.containers.anotherwebservice.com/
...
```
git clone git@github.com:BrunoVieira003/container-lau3ti.git
cd container-lau3ti
```
...
```
docker attach container-lau3ti
```
